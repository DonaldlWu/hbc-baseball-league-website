...
ex... 12/25 排定的三場比賽全數延賽：

- No.209 莫拉克 VS 甜心暴龍（上午）→ gameNumber: `2025209`
- No.45 火把老鷹 VS DH 戰將（中午）→ gameNumber: `2025045`
...
- 12/25：顯示「雨延」（原定場地 中正 A 上午）
- 2/1：顯示「待賽」（補賽場地 中正 A 上午，等比賽結束後更新）
...
- **中午**（第二場）No.106 實踐 OB VS MIRACLE → 9 點前公告
- **下午**（第三場）No.32 HOLYBAT VS 陽明 OB → 9 點前公告
